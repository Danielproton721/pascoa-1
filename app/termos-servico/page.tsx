        ...
        <div className="bg-card rounded-xl border border-border p-6 space-y-6">
          ...
          <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            <section className="space-y-2">
              ...
              <p>
                Ao usar a plataforma da Sabor Doce Chocolates, você concorda com estes Termos de Serviço. Se não concordar
            ...
            <section className="space-y-2">
              ...
              <p>
                A Sabor Doce Chocolates não se responsabiliza por danos indiretos ou consequentes resultantes do uso de
            ...
            <section className="space-y-2">
              ...
              <p>
                Para dúvidas ou reclamações, entre em contato conosco pelo e-mail contato@sabordocechocolates.com.br
              </p>
            </section>
          </div>
